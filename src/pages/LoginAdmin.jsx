...
export default function LoginAdmin() {
  ...
  const onSubmit = async (e) => {
    ...
    setError('')
    setLoading(true)
    try { await login({ email, password, roleHint: 'admin' }) }
      ...
      <div className="card login-card">
        ...
        <div className="card-body">
          ...
          <div className="text-center mt-3">
            <Link to="/forgot-password?portal=admin" className="text-decoration-none">Forgot your password?</Link>
          </div>
          <div className="text-center mt-2">
            <small className="text-muted">
              Other portals: <Link to="/staff" className="text-decoration-none ms-1">Staff</Link> | <Link to="/security" className="text-decoration-none ms-1">Security</Link> | <Link to="/ceo" className="text-decoration-none ms-1">CEO</Link>
            </small>
          </div>
        </div>
      </div>
